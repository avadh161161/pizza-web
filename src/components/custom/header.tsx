...
const Header = () => {
    ...
    return (
        <header className="relative bg-white shadow-md z-50 top-0 sticky">
            <nav className="container py-5 flex items-center justify-between">
                ...
                <div className="flex items-center gap-x-4 hidden sm:flex">
              ...
              {mobileMenuOpen && (
                <div className="md:hidden absolute left-0 right-0 top-full bg-white border-t border-gray-200 z-50 shadow">
                    <ul className="flex flex-col font-medium py-4">
                        ...
                        <li className="px-6 py-3 flex items-center gap-2 text-gray-700 border-t border-gray-100 mt-2 pt-4">
                            <Phone className="w-5 h-5" />
                            <span className="font-medium">+91 9800 098 998</span>
                        </li>
                    </ul>
                </div>
            )}
